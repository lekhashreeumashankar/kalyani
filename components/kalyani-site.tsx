      ...
      >
        ...
        <div className="mx-auto my-auto flex w-full max-w-[1440px] flex-col justify-center px-4 py-6 sm:px-6 sm:py-8 lg:px-12">
          <div className="max-w-3xl animate-fade-in-up">
            ...
            <h1 className="max-w-4xl font-display text-[clamp(2.85rem,11.5vw,3.85rem)] sm:text-6xl md:text-7xl lg:text-[7.5rem] xl:text-[8.5rem] leading-[0.93] sm:leading-[0.93] tracking-[-0.03em] sm:tracking-[-0.04em] text-cream">
